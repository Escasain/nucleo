...
import { IconHome, IconBook, IconCalendar, IconCards, IconGear, IconSearch, IconHelp, IconPlanner, IconChart, IconLink } from './Icons.jsx'
...
const LINKS = [
  ...
  { hash: '#/conexiones', name: 'conexiones', label: 'Conexiones', Icon: IconLink },
