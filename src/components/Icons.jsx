// Iconos SVG inline (trazo 1.8, estilo redondeado)
...
export const IconCards = (p) => (
  <svg {...base} {...p}>
    ...
    <path d="M7 4h13a2 2 0 0 1 2 2v10" />
  </svg>
)
...
export const IconLink = (p) => (
  <svg {...base} {...p}>
    <path d="M10 14a5 5 0 0 0 7.07 0l2.83-2.83a5 5 0 0 0-7.07-7.07L11 5.9" />
    <path d="M14 10a5 5 0 0 0-7.07 0L4.1 12.83a5 5 0 0 0 7.07 7.07L13 18.1" />
  </svg>
)

export const IconDrive = (p) => (
  <svg {...base} {...p}>
    <path d="m8.7 3.5 7 0L22 14.5l-3.5 6h-13L2 14.5z" />
    <path d="M8.7 3.5 12 9.6M15.7 3.5 8.5 20.5M22 14.5H9.3" />
  </svg>
)
